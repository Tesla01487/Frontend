...
const adminNavItems = [
  ...
  { name: 'Buy Settings', href: '/admin/buy-settings', icon: Mail },
  ...
  return (
    <>
          ...
          <div className="flex items-center justify-between h-14 md:h-16">
            ...
            <Link href="/admin/dashboard">
              <motion.div
                ...
                whileTap={{ scale: 0.95 }}
              >
                <div className="w-8 h-8 md:w-10 md:h-10 rounded-lg flex items-center justify-center shadow-lg bg-transparent dark:bg-gradient-to-br dark:from-gray-700 dark:to-gray-900 p-1.5">
                ...
                <div className="hidden sm:block">
                  <h1 className="text-base md:text-lg font-bold bg-gradient-to-r from-blue-500 to-blue-700 bg-clip-text text-transparent">
                    Admin Panel
                  </h1>
                  <p className="text-xs text-muted-foreground hidden md:block">Tesla Management</p>
                </div>
              </motion.div>
            </Link>
            ...
            <div className="flex items-center gap-2 md:gap-4">
              ...
              <motion.button
                ...
                className="hidden md:flex items-center gap-2 px-3 md:px-4 py-2 rounded-lg text-red-500 hover:bg-red-500/10 transition-colors min-w-fit"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                <LogOut className="w-4 h-4 md:w-5 md:h-5 flex-shrink-0" />
                <span className="font-medium whitespace-nowrap hidden lg:inline">Logout</span>
              </motion.button>
        ...
        {sidebarOpen && (
          <>
            ...
            <motion.aside
              ...
              className="fixed left-0 top-14 md:top-16 bottom-0 w-64 bg-card border-r border-border/50 overflow-y-auto z-50 lg:z-40"
            >
      ...
      <motion.aside
        ...
        className="fixed left-0 top-14 md:top-16 bottom-0 w-64 bg-card border-r border-border/50 overflow-y-auto z-40 hidden lg:block"
      >
        <div className="p-4 space-y-1">
          {adminNavItems.map((item) => {
            const Icon = item.icon;
      ...
      <motion.nav
        ...
        className="fixed bottom-0 left-0 right-0 z-50 lg:hidden glass border-t border-border/50 pb-safe"
      >
          ...
          {adminNavItems.slice(0, 4).map((item) => {
            ...
            return (
              <Link key={item.href} href={item.href}>
                <motion.div
                  className={cn(
                    "flex flex-col items-center justify-center p-2 md:p-3 rounded-lg transition-colors relative",
                    isActive
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  <Icon className={cn("w-5 h-5 md:w-6 md:h-6", isActive && "relative z-10")} />
